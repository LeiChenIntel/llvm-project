...
private:
  ...
  mlir::Value mlirGen(ExprAST &expr) {
    switch (expr.getKind()) {
    case standalone::ExprAST::Expr_BinOp:
      return mlirGen(cast<BinaryExprAST>(expr));
    case standalone::ExprAST::Expr_Var:
      return mlirGen(cast<VariableExprAST>(expr));
    case standalone::ExprAST::Expr_Literal:
      return mlirGen(cast<LiteralExprAST>(expr));
    case standalone::ExprAST::Expr_Call:
      return mlirGen(cast<CallExprAST>(expr));
    case standalone::ExprAST::Expr_Num:
